...
import { MyV2FlashLoanV2, IWETH, Logic } from "../typechain-types/index"
...
describe("testing for ", async () => {
    ...
    beforeEach(async () => {
        ...
        const C2 = await ethers.getContractFactory("Logic")
        contract2 = (await C2.deploy(contract.address)) as Logic
